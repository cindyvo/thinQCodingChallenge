...
class AccessTokenHandler {
    constructor({ authority, apiName = "", apiSecret = "", requireHttpsMetadata = true, supportedTokens = supported_tokens_model_1.SupportedTokens.Both, tokenTypeHint = token_types_1.default.AccessToken, enableCache = true, cacheDuration = 300, checkAudience = true }) {
        ...
        this.jwtTokenHandler = new jwt_token_handler_1.default(new jwt_bearer_options_1.default(authority, requireHttpsMetadata, apiName, checkAudience));
        if (apiSecret === "") {
